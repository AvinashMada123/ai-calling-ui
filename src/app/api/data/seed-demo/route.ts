...
const PRODUCT_SECTIONS = [
  {
    name: "AI Masterclass Overview",
    content:
      "The Freedom with AI Masterclass is an intensive, hands-on program designed for professionals, entrepreneurs, and business owners who want to leverage AI to 10x their productivity. Over 3 days, participants learn to build AI-powered automation workflows, create intelligent chatbots, set up AI calling systems, and integrate AI into their existing business processes. No coding experience required — we use no-code and low-code tools that anyone can master.",
    keywords: ["masterclass", "program", "course", "what is", "about", "overview"],
  },
  {
    name: "Key Features & Curriculum",
    content:
      "Day 1: AI Foundations & Prompt Engineering — Master advanced prompting, learn to use Claude, GPT-4, and Gemini effectively. Day 2: AI Automation & Workflows — Build end-to-end automation using n8n, Make.com, and Zapier. Create AI agents that handle customer support, lead qualification, and data processing. Day 3: AI Business Integration — Set up AI calling systems, WhatsApp automation, CRM integration, and AI-powered analytics dashboards. Bonus: Access to our private community, 50+ pre-built AI workflow templates, and 6 months of mentorship.",
    keywords: ["curriculum", "learn", "topics", "features", "what will", "schedule", "days"],
  },
  {
    name: "Pricing & Plans",
    content:
      "Standard Access: Rs 4,999 — Includes all 3 days of live training, recordings, and community access. Premium Access: Rs 9,999 — Everything in Standard plus 1-on-1 mentorship sessions, premium templates, and priority support. Enterprise: Custom pricing — Team licenses for 5+ members, custom workshops, and dedicated account manager. Early bird discount of 30% available for registrations made 7+ days before the event.",
    keywords: ["price", "cost", "how much", "fee", "payment", "discount", "offer", "plan"],
  },
  {
    name: "Benefits & Outcomes",
    content:
      "After completing the masterclass, participants can: automate 60-80% of repetitive business tasks, build AI chatbots for customer support in under 2 hours, set up AI-powered calling systems for sales and follow-ups, create content 10x faster using AI workflows, qualify and nurture leads automatically. Average participant reports saving 12 hours/week within the first month of implementation.",
    keywords: ["benefit", "outcome", "result", "what do i get", "after", "achieve", "gain"],
  },
  {
    name: "Testimonials & Success Stories",
    content:
      "Rajesh K., Startup Founder: 'Automated my entire lead follow-up process. Went from 20 calls/day manually to 200 AI-powered calls. Revenue up 340% in 3 months.' Priya M., Marketing Manager: 'Built an AI content pipeline that produces a week's worth of social media content in 30 minutes. My team now focuses on strategy instead of execution.' Suresh B., Freelancer: 'Started offering AI automation services to clients. Went from Rs 50K/month to Rs 3L/month within 4 months of completing the masterclass.'",
    keywords: ["testimonial", "review", "success", "story", "result", "who has", "others"],
  },
  {
    name: "Objection Handling - Common Concerns",
    content:
      "\"I'm not technical\" — 90% of our participants have zero coding background. We use drag-and-drop tools. \"I don't have time\" — The masterclass is 3 days, and the skills save you 10+ hours every week going forward. \"Is AI just hype?\" — Companies using AI are growing 2-5x faster than competitors. McKinsey estimates AI will add $13 trillion to the global economy by 2030. \"Can I learn this from YouTube?\" — You can learn basics, but our masterclass gives you implementation frameworks, live support, and proven templates that save months of trial and error.",
    keywords: ["concern", "but", "worry", "objection", "hesitation", "doubt"],
  },
];
...
export async function POST(request: NextRequest) {
  try {
    ...
    for (const persona of PERSONAS) {
      const ref = db.collection("organizations").doc(orgId).collection("personas").doc();
      personaBatch.set(ref, { id: ref.id, ...persona, updatedAt: now });
      totalSeeded++;
    }
    for (const situation of SITUATIONS) {
      const ref = db.collection("organizations").doc(orgId).collection("situations").doc();
      personaBatch.set(ref, { id: ref.id, ...situation, updatedAt: now });
      totalSeeded++;
    }
    ...
    for (const section of PRODUCT_SECTIONS) {
      const ref = db.collection("organizations").doc(orgId).collection("productSections").doc();
      productBatch.set(ref, { id: ref.id, ...section, updatedAt: now });
      totalSeeded++;
    }
